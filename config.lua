...
Config.Arcade = {
    {
        NPC = {
            position = vector3(336.01, -908.13, 28.26),
            heading = 351.63,
            model = "ig_claypain",
        },
        blip = {
            position = vector3(-1654.57, -1077.14, 13.15),
            blipId = 521,
            scale = 1.0,
            color = 0,
            name = "Arcade house",
        ...
        marker = {
            markerPosition = vector3(336.15, -906.07, 28.80),
            markerType = 23,
            options = {
...
Config.computerList = {
    -- Retro machines
    {
        ...
        markerType = 31,
        position = vector3(323.73, -919.93, 29.25),
        markerOptions = {
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 31,
        position = vector3(326.68, -913.04, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 255, g = 255, b = 255, a = 125 },
            rotate = true,
    ...
    -- Gaming computers
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(-1663.25, -1072.54, 12.76),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(324.95, -912.94, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(323.74, -916.58, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(328.26, -927.91, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(323.61, -918.27, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    --[[{
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(-1650.35, -1066.25, 12.16),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(-1661.27, -1077.16, 12.76),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
